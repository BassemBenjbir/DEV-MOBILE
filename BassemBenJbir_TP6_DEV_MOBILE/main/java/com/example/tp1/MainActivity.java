...
public class MainActivity extends AppCompatActivity {
          private TextView Age ,tvresultat,rbtvaleur ;
          private SeekBar id;
          private EditText ed;
          private Button bt;
                ...
                if (bouiChecked) {
                    if (age >= 13) {
                        if (valeurMesuree < 5.0)
                            rbtvaleur.setText("Niveau de glycémie est trop bas");
                        else if (valeurMesuree >= 5.0 && valeurMesuree <= 7.2)
                            rbtvaleur.setText("Niveau de glycémie est normale");
                        else
                            rbtvaleur.setText("Niveau de glycémie est trop élevé");
